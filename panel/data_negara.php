                            ...
                            <div class="card-box table-responsive">
                                <div class="text-muted font-12 m-b-30 mb-2">
                                    ...
                                    <div class="btn float-right">
                                        <a class="btn btn-sm btn-danger" onclick="return confirm('Semua Data Akan Terhapus!')" href="hapus_negara.php" role="button"><i class="fa fa-trash" aria-hidden="true"></i> Delete All</a>
                                        <a class="btn btn-sm btn-info" href="file-excel/template_data_negara.xlsx" target="_blank" role="button"><i class="fa fa-cloud-download" aria-hidden="true"></i> Download Template Excel</a>
                                        <a class="btn btn-sm btn-primary" href="upload_negara.php" role="button"><i class="fa fa-upload" aria-hidden="true"></i> Upload Data</a>
