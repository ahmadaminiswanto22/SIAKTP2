...
if (isset($_POST["submit"])) {
    ...
    if (empty($err)) {
        ...
        for ($i = 2; $i < count($sheetData); $i++) {
            $id_jurusan = $sheetData[$i]['1'];
            $nama_jurusan = $sheetData[$i]['2'];
            $id_jenjang = $sheetData[$i]['3'];
            $tgl_input = $sheetData[$i]['4'];
            $user_input = $sheetData[$i]['5'];
            ...
            $query = "INSERT INTO jurusan (id_jurusan,nama_jurusan,id_jenjang,tgl_input,user_input,id_user) VALUES('$id_jurusan','$nama_jurusan','$id_jenjang','$date','$user_input','$id_user')";
            // var_dump($query);
            // exit();
